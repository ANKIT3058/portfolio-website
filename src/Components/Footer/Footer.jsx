  ...
  return (
    <footer className='footer'>
      <div className="footer-top">
        <img className="footer-logo" src={footer_logo} alt="Ankit Kumar Anand logo" />
        <p className="footer-description">
          Computer Science undergraduate at MNNIT Allahabad passionate about backend engineering,
          full-stack development, and building software that solves real-world problems.
        </p>
      </div>
